            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="footer-info">
                        ...
                        <p>{{ array_key_exists('contact_address', $data['homepage_lists_contact']) ? strip_tags($data['homepage_lists_contact']['contact_address']) : "" }}<br><br><strong>Phone:</strong> {{ array_key_exists('contact_phone_number', $data['homepage_lists_contact']) ? $data['homepage_lists_contact']['contact_phone_number'] : "" }}<br> <strong>Email:</strong> {{ array_key_exists('contact_email', $data['homepage_lists_contact']) ? strip_tags($data['homepage_lists_contact']['contact_email']) : "" }}<br> </p>
    ...
    <div class="footer-legal text-center position-relative">
        <div class="container">
            ...
            <div class="credits">
                ...
                <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/upconstruction-bootstrap-construction-website-template/ --> Designed by <a href="https://bootstrapmade.com/">BootstrapMade</a>
            </div>
        </div>
    </div>
</footer> <!-- End Footer -->
